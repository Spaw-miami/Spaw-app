        ...
        <div className="pet-owner">
          ...
          <div className="form-container">
            <div className="work">
              ...
              <button className="switchbutton" onClick={this.groomerOrUser}>Are you a Pet Groomer?</button>
                          ...
                          <div className="panel panel-primary">
                            ...
                            >
                              <label htmlFor="step2" id="back-step2" className="back">
                                <div className="btn btn-default btn-primary btn-lg" role="button">
                                  Back
          >>>>>>> 34f160380b3da816910a82a1e7b108794bbf2bfd
											</div>
                              </label>
    ...
    return (
      <Fragment>
                <div className="pet-groomer">
                  ...
                  <div className="form-container">
                    <img className="logo" src="./images/Spaws_white.png" width='200' alt='logo' />
                    <button className="switchbutton" onClick={this.groomerOrUser}>Are you a Pet Owner?</button>
